            ...
            {services.map((s) => (
              <div key={s.title} className="bg-card rounded-xl border border-border p-8 text-center shadow-sm flex flex-col">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-[#1E3A8A] text-white font-semibold rounded-lg hover:bg-[#1D4ED8] transition-colors text-sm"
                >
                  Ajukan Penawaran →
                </Link>
              </div>
