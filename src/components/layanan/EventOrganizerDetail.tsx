      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((s) => (
              <div key={s.title} className="bg-card rounded-xl border border-border p-8 text-center shadow-sm flex flex-col">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-6 flex-grow">{s.description}</p>
                <Link
                  to="/layanan/event-organizer"
                  className="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors text-sm"
                >
                  Ajukan Penawaran →
                </Link>
              </div>
