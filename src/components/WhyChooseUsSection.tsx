import { CheckCircle, Users, BookOpen, Shield, Settings, BarChart3 } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    description: "Mendesain dan menyelenggarakan program pelatihan sumber daya manusia yang efektif dan berdampak.",
    points: [
      "Pelatihan Berbasis Kompetensi",
      "Sertifikasi Profesi Keahlian",
      "Sertifikasi Produk Keahlian",
    ],
  },
  {
    icon: BookOpen,
    title: "Integrasi Solusi Kreatif & Operasional",
    description: "Kami mendukung perusahaan dari sisi kreatif dan operasional, termasuk event management dan branding.",
    points: [
      "Solusi Event & MICE",
      "Desain & Manufaktur Terintegrasi",
    ],
  },
  {
    icon: BarChart3,
    title: "Monitoring & Supervisi Berkelanjutan",
    description: "Layanan pengawasan dan evaluasi untuk memastikan standar profesional yang berkelanjutan serta kualitas layanan terbaik.",
    points: [
      "Evaluasi Kinerja Operasional",
      "Audit dan Compliance Monitoring",
    ],
  },
];
